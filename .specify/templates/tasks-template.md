...
- [ ] T010 [P] Define or update zod schemas for all write/update flows in src/validation/
- [ ] T011 Implement secure IPC service wrappers via `window.electronAPI` only
- [ ] T012 Add consistent IPC try/catch handling with user-friendly sonner toasts
- [ ] T013 [P] Extract complex UI state into custom hooks (form/designer/customers)
...
- [ ] T020 [US1] Add zod validation and IPC error handling
...
- [ ] TXXX Verify component file sizes and refactor files above 300 lines
